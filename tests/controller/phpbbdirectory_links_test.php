...
namespace nextgen\phpbbdirectory\tests\controller
{
	...
	class phpbbdirectory_links_test extends controller_base
	{
		...
		/**
		 * Test data for the test_delete_link() function
		 *
		...
		{
			return array(
				array(1, 1, 2, 200, 'DIR_DELETE_OK<br /><br />DIR_CLICK_RETURN_DIR<br /><br />DIR_CLICK_RETURN_CAT'),
			);
		}
		 ...
		 *
		 * @dataProvider delete_link_data
		 */
		public function test_delete_link($cat_id, $link_id, $user_id, $status_code, $page_content)
		{
		...
		{
			return array(
				array(1, 1, 2, false, array(), 200, 'add_site.html'),
				array(2, 2, 2, false, array(), 200, 'add_site.html'),
		 ...
		 */
		public function test_edit_link($cat_id, $link_id, $user_id, $submit, $params, $status_code, $page_content)
		{
			$user_data = $this->auth->obtain_user_data($user_id);
			$this->auth->acl($user_data);
		...
		{
			return array(
				array(1 ,2, false, array(), 200, 'add_site.html'),
				array(2 ,2, false, array(), 200, 'add_site.html'),
				array(3 ,2, false, array(), 200, 'add_site.html'),
		 ...
		 */
		public function test_new_link($cat_id, $user_id, $submit, $params, $status_code, $page_content)
		{
			$user_data = $this->auth->obtain_user_data($user_id);
			$this->auth->acl($user_data);
